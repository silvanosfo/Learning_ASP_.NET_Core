...
namespace EquiMembros2023.Controllers
{
    public class EquipasController : Controller
    {
        ...
        {
              return _context.Tequipas != null ? 
                          View(await _context.Tequipas.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.Tequipas'  is null.");
        }

        // GET: Equipas/Details/5
        public async Task<IActionResult> Details(int? id)
        {
            if (id == null || _context.Tequipas == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.Tequipas == null)
            {
                return Problem("Entity set 'ApplicationDbContext.Tequipas'  is null.");
            }
            var equipa = await _context.Tequipas.FindAsync(id);
            if (equipa != null)
            {
        ...
        {
          return (_context.Tequipas?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
